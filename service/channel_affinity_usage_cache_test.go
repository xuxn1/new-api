...
func TestObserveChannelAffinityUsageCacheByRelayFormat_ClaudeMode(t *testing.T) {
	ruleName := testChannelAffinityUsageCacheKey(t, "rule")
	usingGroup := "default"
	keyFP := testChannelAffinityUsageCacheKey(t, "fp")
...
func testChannelAffinityUsageCacheKey(t *testing.T, prefix string) string {
	t.Helper()
